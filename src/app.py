...
if __name__ == '__main__':
    ...
    parser.add_argument('--abstractive_path', default='seidel/', type=str)
    parser.add_argument('--abstractive_model_name', default='plsum-base-ptt5', type=str)
    parser.add_argument('--abstractive_checkpoint', default=None, type=str)
